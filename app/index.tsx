...
export default function AddMedicineScreen() {
  ...
  const onSave = async () => {
    try {
      ...
      console.log('[AddMedicine] 🔍 DEBUG - Medicamento a guardar:', JSON.stringify(item, null, 2));
      console.log('[AddMedicine] 🔍 DEBUG - selectedDates:', Object.keys(selectedDates));
      
      // Mostrar alerta de depuración
      Alert.alert('DEBUG', `Fechas seleccionadas: ${Object.keys(selectedDates).length} fechas`);
      ...
      if (totalNotifications > 0 && notificationErrors === 0) {
        ...
        Alert.alert(
          "✅ Guardado", 
          `Tu medicamento fue agregado con éxito.`,
        ...
        Alert.alert(
          ...
          `Tu medicamento fue agregado con éxito.\n\nAlgunos horarios no se pudieron programar.`,
          [{ text: 'OK', onPress: () => nav.navigate("Lista") }]
        );
      } else {
        // Limpiar formulario
