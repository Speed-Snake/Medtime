...
import AddMedicine from "../app/index";
import EditMedicine from "../app/editMedicine";
...
function AppAuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const [medicinesUpdated, setMedicinesUpdated] = useState(0);

  const notifyMedicinesUpdate = () => {
    setMedicinesUpdated(prev => prev + 1);
  };
  ...
  return (
    <AuthContext.Provider value={value}>
      ...
      <AlarmModal
        ...
        onMedicinesUpdate={notifyMedicinesUpdate}
      />
  ...
  return (
    ...
    >
      ...
      <Drawer.Screen 
        ...
        options={{
          drawerItemStyle: { display: 'none' }, // Ocultar del sidebar
        }}
      />
      <Drawer.Screen 
        name="Lista" 
